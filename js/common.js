window.onload = function () {
    ...
    star();
    show_date_time();
    document.querySelectorAll('.copyright')[0].innerHTML = '<div>©2022 <i class="fa-fw fas fa-heartbeat card-announcement-animation cc_pointer"></i> By 初心 </div><div><img class="beian" src="./img/beian.png" />豫公网安备4103292000309号 </div>'
